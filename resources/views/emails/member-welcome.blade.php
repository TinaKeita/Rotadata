...
<body style="margin:0; padding:0; background-color:#f4f2ee; -webkit-font-smoothing:antialiased;">
	...
	<div style="display:none; max-height:0; overflow:hidden; opacity:0;">
		Your account has been created. Your temporary password is in the email below.
	</div>
					...
					<tr>
						<td style="padding:32px;">
							...
							<p style="margin:0 0 24px; font-size:15px; line-height:1.6; color:#555555;">
								@if($groupName)
									Your teacher set up an account for you in the group <strong>{{ $groupName }}</strong> to manage the costume inventory.
								@else
